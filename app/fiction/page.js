...
const FictionPage = () => {
  ...
  // Fetch fiction books from the Google Books API
  const fetchFictionBooks = async () => {
    ...
    try {
      ...
      setError("Error fetching fiction books. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="pt-[100px] px-4 dark:bg-[#0e1628] dark:text-white transition-all pb-20 pl-20 pr-20">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-semibold">Fiction Books</h2>
